...
module.exports.getReply = function(code) {
  const replies = {
    ...
    'A0': [
      ...
      carousels.dynamicCarousel([{"code":"A1","label":"如何申請地籍謄本","keyword":"謄本申請","thumbnail":"登記底圖.png"},{"code":"A2","label":"登記費、書狀費如何計算","keyword":"登記規費","thumbnail":"登記底圖.png"},{"code":"A3","label":"如何查詢登記案件公告","keyword":"公告","thumbnail":"登記底圖.png"},{"code":"A4","label":"如何查詢登記案件辦理情形","keyword":"登記案件辦理情形","thumbnail":"登記底圖.png"},{"code":"A5","label":"哪些登記案件可以跨所申請","keyword":"跨所登記","thumbnail":"登記底圖.png"},{"code":"A6","label":"地政便民工作站有哪些服務","keyword":"便民工作站","thumbnail":"登記底圖.png"},{"code":"A7","label":"如何申請住址變更","keyword":"住址變更","thumbnail":"登記底圖.png"},{"code":"A8","label":"如何查詢名下不動產資料","keyword":"歸戶查詢","thumbnail":"登記底圖.png"},{"code":"A9","label":"地政相關表單下載","keyword":"書表下載","thumbnail":"登記底圖.png"},{"code":"A10","label":"常見登記案件申辦須知","keyword":"案件辦理須知","thumbnail":"登記底圖.png"}], BASE_URL),
      carousels.dynamicCarousel([{"code":"A11","label":"如何辦理繼承","keyword":"繼承","thumbnail":"登記底圖.png"},{"code":"A12","label":"如何辦理地籍異動即時通","keyword":"地籍異動即時通","thumbnail":"登記底圖.png"},{"code":"A13","label":"如何辦理住址隱匿","keyword":"住址隱匿","thumbnail":"登記底圖.png"},{"code":"A14","label":"如何線上辦理土地登記","keyword":"數位櫃台","thumbnail":"登記底圖.png"},{"code":"A15","label":"如何查詢合法地政士","keyword":"地政士","thumbnail":"登記底圖.png"},{"code":"A16","label":"外籍及大陸地區人士專區","keyword":"外國人","thumbnail":"登記底圖.png"}], BASE_URL)
    ],
    'B0': [
    ...
    'C0': [
      ...
      carousels.dynamicCarousel([{"code":"C1","label":"如何查詢公告土地現值","keyword":"公告土地現值","thumbnail":"地價底圖.png"},{"code":"C2","label":"如何試算土地增值稅","keyword":"增值稅試算","thumbnail":"地價底圖.png"},{"code":"C3","label":"更多實價登錄相關資訊","keyword":"實價登錄","thumbnail":"地價底圖.png"},{"code":"C4","label":"如何申報買賣實價登錄","keyword":"買賣實價登錄","thumbnail":"地價底圖.png"},{"code":"C5","label":"如何申報租賃及預售屋實價登錄","keyword":"預售屋實價登錄","thumbnail":"地價底圖.png"},{"code":"C6","label":"如何查詢實價登錄資訊","keyword":"實價登錄查詢網站","thumbnail":"地價底圖.png"},{"code":"C7","label":"實價登錄的申報期限","keyword":"申報期限","thumbnail":"地價底圖.png"},{"code":"C8","label":"哪些情形需要申報實價登錄","keyword":"實價登錄申報種類","thumbnail":"地價底圖.png"}], BASE_URL)
    ],
    'D0': [
    ...
    'E0': [
      ...
      carousels.dynamicCarousel([{"code":"E1","label":"辦理更正編定須準備什麼","keyword":"更正編定","thumbnail":"地用底圖.png"},{"code":"E2","label":"辦理變更編定須準備什麼","keyword":"變更編定","thumbnail":"地用底圖.png"},{"code":"E3","label":"如何查詢土地參考資訊檔","keyword":"土地參考資訊檔","thumbnail":"地用底圖.png"},{"code":"E4","label":"如何查詢國土計畫法相關資料","keyword":"國土計劃","thumbnail":"地用底圖.png"},{"code":"E5","label":"農地違規使用有什麼罰則","keyword":"違規使用","thumbnail":"地用底圖.png"},{"code":"E6","label":"如何查詢土地容許使用項目","keyword":"容許使用","thumbnail":"地用底圖.png"},{"code":"E7","label":"更多土地使用相關資訊","keyword":"地用","thumbnail":"地用底圖.png"}], BASE_URL)
    ],
    'F0': [
      { type: 'text', text: '請選擇【檔案及綜合業務】項目：' },
      carousels.dynamicCarousel([{"code":"F1","label":"申請檔案應用需要準備什麼","keyword":"檔案應用","thumbnail":"檔案應用底圖.png"},{"code":"F2","label":"申請擔任志工需要準備什麼","keyword":"志工招募","thumbnail":"檔案應用底圖.png"},{"code":"F3","label":"申請寒暑假青年志工需要準備什麼","keyword":"青年志工","thumbnail":"檔案應用底圖.png"}], BASE_URL)
    ],
...
如您尚有其他問題，可撥打本所電話03-4917647，將有專人進一步協助您，謝謝您！` },
      { type: 'image', originalContentUrl: `${BASE_URL}/public/謄本申請.jpg`, previewImageUrl: `${BASE_URL}/public/謄本申請.jpg` }
    ],
    'A2': [
      { type: 'text', text: `阿吸，您好！
■　地政規費之收費標準連結點如下：
...
如您尚有其他問題，可撥打本所電話03-4917647，將有專人進一步協助您，謝謝您！` },
      { type: 'image', originalContentUrl: `${BASE_URL}/public/跨所登記.jpg`, previewImageUrl: `${BASE_URL}/public/跨所登記.jpg` }
    ],
    'A6': [
      { type: 'text', text: `阿吸，您好！
■　本所地政便民工作站服務項目資訊如下：
...
如您尚有其他問題，可撥打本所電話03-4917647，將有專人進一步協助您，謝謝您！` },
      { type: 'image', originalContentUrl: `${BASE_URL}/public/便民工作站.jpg`, previewImageUrl: `${BASE_URL}/public/便民工作站.jpg` }
    ],
    'A7': [
      { type: 'text', text: `阿吸，您好！
■　住址變更方式資訊如下:
...
https://land.tycg.gov.tw/cp.aspx?n=3975
如查詢不到您想要的資料，可洽本所 03-4917647 協助您~` },
      { type: 'image', originalContentUrl: `${BASE_URL}/public/QR地籍異動即時通申請書.jpg`, previewImageUrl: `${BASE_URL}/public/QR地籍異動即時通申請書.jpg` },
      { type: 'image', originalContentUrl: `${BASE_URL}/public/地籍異動即時通文宣.jpg`, previewImageUrl: `${BASE_URL}/public/地籍異動即時通文宣.jpg` }
    ],
    'A13': [
      { type: 'text', text: `阿吸您好~
...
如查詢不到您想要的資料，可洽本所 03-4917647 協助您~` },
      { type: 'image', originalContentUrl: `${BASE_URL}/public/QR住址隱匿即時通申請書.jpg`, previewImageUrl: `${BASE_URL}/public/QR住址隱匿即時通申請書.jpg` }
    ],
    'A14': [
      { type: 'text', text: `阿吸，您好！
...
如您尚有其他問題，可撥打本所電話03-4917647，將有專人進一步協助您，謝謝您！` },
      { type: 'image', originalContentUrl: `${BASE_URL}/public/地政士.jpg`, previewImageUrl: `${BASE_URL}/public/地政士.jpg` }
    ],
    'A16': [
      { type: 'text', text: `阿吸，您好！
■　外籍及大陸地區人士專區
...
如查詢不到您想要的資料，可洽本所 03-4917647 分機503呂先生協助您~` },
      { type: 'image', originalContentUrl: `${BASE_URL}/public/QR土地基本資料庫電子資料申請表.jpg`, previewImageUrl: `${BASE_URL}/public/QR土地基本資料庫電子資料申請表.jpg` }
    ],
    'B1': [
      { type: 'text', text: `阿吸，您好！
...
(Cony hug)有關其他測量規費計費方法請輸入關鍵字「測量費」以獲取更多資訊!!` },
      { type: 'image', originalContentUrl: `${BASE_URL}/public/複丈試算網站介紹.jpg`, previewImageUrl: `${BASE_URL}/public/複丈試算網站介紹.jpg` }
    ],
    'B2': [
      { type: 'text', text: `阿吸，您好！
112年 5月 1日以後申辦土地複丈案件，將由地政事務所提供制式界標予申請人使用，申請人「不用」再自行準備制式界標；但應注意地政事務所僅提供界標予申請人使用，還是要由申請人自行埋設並妥為維護管理，因此現場記得幫我們準備鐵鎚或方便埋設界標的工具，以利複丈作業進行。` },
      { type: 'image', originalContentUrl: `${BASE_URL}/public/免自備制式界標文宣.jpg`, previewImageUrl: `${BASE_URL}/public/免自備制式界標文宣.jpg` }
    ],
    'B3': [
      { type: 'text', text: `阿吸，您好！
...
(Cony hug)提醒於繪製完成後記得匯出中央政府鎖定共通格式電子檔（*zjb)，連同案件送交地政事務所辦理，可省下每建號600元之數值化作業喔!!` },
      { type: 'image', originalContentUrl: `${BASE_URL}/public/共通式電子檔建物向量圖.jpg`, previewImageUrl: `${BASE_URL}/public/共通式電子檔建物向量圖.jpg` }
    ],
    'B6': [
      { type: 'text', text: `阿吸，您好！
...
https://www.zhongli-land.tycg.gov.tw/News_Content.aspx?n=14066&s=1090602` },
      { type: 'image', originalContentUrl: `${BASE_URL}/public/建物地籍測繪資料.jpg`, previewImageUrl: `${BASE_URL}/public/建物地籍測繪資料.jpg` }
    ],
    'B8': [
      { type: 'text', text: `阿吸，您好！
...
如您尚有其他問題，可撥打本所電話03-4917647分機245、202，將有專人進一步協助您，謝謝您！` },
      { type: 'image', originalContentUrl: `${BASE_URL}/public/測量收費標準.jpg`, previewImageUrl: `${BASE_URL}/public/測量收費標準.jpg` }
    ],
    'C3': [
